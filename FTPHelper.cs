...
namespace AutoUpdate
{
    public class FTPHelper
    {
        ...
        static bool ftpKeepAlive;
        static bool ftpBinary;
        static bool ftpPassive;

        /// <summary>
        /// 连接FTP
        /// </summary>
        /// <param name="FtpServerIP">FTP连接地址</param>
        /// <param name="FtpRemotePath">指定FTP连接成功后的目录(不包含文件名称), 如果不指定即默认为根目录</param>
        /// <param name="FtpUserID">用户名</param>
        /// <param name="FtpPassword">密码</param>
        public FTPHelper(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword,bool passive)
        {
        ...
        public void SetFtp(bool bKeepAlive,bool bBinary,bool bPassive)
        {
            ftpKeepAlive = bKeepAlive;
            ftpBinary = bBinary;
            ftpPassive = bPassive;
        }
        /// <summary>
